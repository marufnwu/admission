<?php
    ...
    if (isset($_POST['guardianName']) && isset($_POST['guardianEmail'])) {
        ...
        $mail->Password = 'qqngtreykwlopsmr'; 
        $mail->Port = 465;
      ...
      //  var_dump(array("status" => $status, "response" => $response));
    ...
    if (isset($_POST['guardianNameSec']) && isset($_POST['guardianEmailSec'])) {
        ...
        $mail_new->Password = 'qqngtreykwlopsmr'; 
        $mail_new->Port = 465;
        $mail_new->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
